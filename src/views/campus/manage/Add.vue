<template>
  <div class="situation">
    <el-scrollbar style="height:100%" :noresize="true">
      <el-form :model="organInfo" :rules="rules" ref="ruleForm" label-width="0" class="demo-ruleForm">
        <div class="basic">
...
<!--            <el-button type="text" @click="editHandler">{{disabled ? '编辑' : '保存'}}</el-button>-->
          ...
          <div class="row">
            <div class="OEP-form-item margin_r_48">
              <div class="container">
                <p class="label">合作单位名称<span class="required-icon">*</span></p>
            ...
            <div class="OEP-form-item margin_r_48">
              <div class="container">
                <p class="label">机构性质 <span class="required-icon">*</span></p>
            ...
            <div class="OEP-form-item margin_r_48">
              <div class="container">
                <p class="label">合作状态<span class="required-icon">*</span></p>
            ...
            <div class="OEP-form-item margin_r_48">
              <div class="container">
                <p class="label">依托单位名称<span class="required-icon">*</span></p>
            ...
            <div class="OEP-form-item margin_r_48">
              <div class="container">
                <p class="label">依托单位性质<span class="required-icon">*</span></p>
            ...
            <div class="OEP-form-item margin_r_48">
              <div class="container">
                <p class="label">用户数量限制 <span class="required-icon">*</span></p>
        ...
        <div class="row">
          <div class="contact">
            ...
            <el-tabs class="users-tab" v-model="activeIndex" :stretch="true" @tab-click="tabsHandleClick">
              <el-tab-pane label="负责人/法人 *" name="0">
                <div class="contact-info">
                  ...
                  <div class="OEP-form-item margin_r_48">
                    <div class="container">
                      <p class="label">身份证<span v-if="activeIndex === '0'" class="required-icon">*</span></p>
                  ...
                  <div class="OEP-form-item margin_r_48">
                    <div class="container">
                      <p class="label">性别<span v-if="activeIndex === '0'" class="required-icon">*</span></p>
                      <div class="radio-container">
                        <el-form-item prop="contactsSex">
                          <el-radio-group v-model="organInfo.contactInfoS[0].sex" :disabled="disabled">
                  ...
                  <div class="OEP-form-item margin_r_48">
                    <div class="container">
                      <p class="label">手机号码<span v-if="activeIndex === '0'" class="required-icon">*</span></p>
                  ...
                  <div class="OEP-form-item margin_r_48">
                    <div class="container">
                      <p class="label">地址 <span v-if="activeIndex === '0'" class="required-icon">*</span></p>
                ...
                <div class="contact-info" v-if="organInfo.contactInfoS[1]">
                  ...
                  <div class="OEP-form-item margin_r_48">
                    <div class="container">
                      ...
                      <div class="radio-container">
                        <el-form-item>
                          <el-radio-group v-model="organInfo.contactInfoS[1].sex" @input="forceChange()" :disabled="disabled">
                            <el-radio class="form-item-radio" label="1">男</el-radio>
                            <el-radio class="form-item-radio" label="2">女</el-radio>
                          </el-radio-group>
                        </el-form-item>
                ...
                <div class="contact-info" v-if="organInfo.contactInfoS[2]">
                  ...
                  <div class="OEP-form-item margin_r_48">
                    <div class="container">
                      ...
                      <div class="radio-container">
                        <el-form-item>
                          <el-radio-group v-model="organInfo.contactInfoS[2].sex" @input="forceChange()" :disabled="disabled">
                            <el-radio class="form-item-radio" label="1">男</el-radio>
                            <el-radio class="form-item-radio" label="2">女</el-radio>
                          </el-radio-group>
                        </el-form-item>
                ...
                <div class="contact-info" v-if="organInfo.contactInfoS[3]">
                  ...
                  <div class="OEP-form-item margin_r_48">
                    <div class="container">
                      ...
                      <div class="radio-container">
                        <el-form-item>
                          <el-radio-group v-model="organInfo.contactInfoS[3].sex" @input="forceChange()" :disabled="disabled">
                            <el-radio class="form-item-radio" label="1">男</el-radio>
                            <el-radio class="form-item-radio" label="2">女</el-radio>
                          </el-radio-group>
                        </el-form-item>
        ...
        <div>
          ...
          <div class="row">
            ...
            <div class="OEP-form-item margin_r_48">
              <div class="container">
                <p class="label">首批学生入学日期 <span class="required-icon">*</span></p>
                <el-form-item prop="firstDate">
                  <el-date-picker
                      class="form-item-input"
...
<script>
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        rules: {
          ...
          approveDate: [
            { required: true, message: '请选择行政部门审核时间', trigger: 'blur' }
          ],
          approveNo: [
            { required: true, message: '请输入行政部门批准文号', trigger: 'blur' }
          ],
          lastApproveDate: [
            { required: true, message: '请选择最近一次审核意见', trigger: 'blur' }
          ],
          lastApproveIdea: [
            { required: true, message: '请选择最近一次审核意见', trigger: 'blur' }
          ],
          lastContractDate: [
            { required: true, message: '请选择最近一次合同日期', trigger: 'blur' }
          ],
          firstDate: [
            { required: true, message: '请选择首批学生入学日期', trigger: 'blur' }
          ],
          'contactsName': [
          ...
          'contactsAddress': [
            { validator: testAddress, trigger: 'blur' }
          ],
          'contactsSex': [
    ...
    methods: {
      init() {
        this.organInfo = this.organ ? cloneDeep(this.organ) : this.createNewOrgan()
        this.fileList = this.organInfo.unitCertUrl ? this.organInfo.unitCertUrl.split('&') : []
        this.activeIndex = '0'
      },
      createNewOrgan() {
        return {
      ...
      tabsHandleClick({ name }) {
        const index = name
        this.organInfo.contactInfoS[index] = this.organInfo.contactInfoS[index] || this.addNewContact(index)
      },
      save(callback) {
      ...
      async update(callback) {
        ...
        this.organInfo.unitCertUrl = this.fileList.join('&')
        if (this.isAdd) {
          api.addOrgan(this.organInfo).then(res => {
            console.log(res)
            if (res.data) {
              this.$message({
                message: '添加成功',
          ...
          api.updateOrgan(this.organInfo).then(res => {
            console.log(res)
            if (res.data) {
              this.$message({
                message: '更新成功',
      ...
      deleteImgHandler(dIndex) {
        ...
        this.organInfo.unitCertUrl = this.organInfo.unitCertUrl.split('&').filter((e, i) => i !== dIndex).join('&')
      }
    }
  }
</script>
