      ...
      <div class="main-content-container">
        ...
        >
          <div slot-scope="{ scope }" style="width:200px">
            ...
            <span class="opr" @click="handleApprove(scope)">审核</span>
...
export default {
  ...
  methods: {
    ...
    handleApprove({ row }) {
      if (row.approveStatus !== '1') { return this.$message.warning('只能操作待审批！') }
    ...
    async getTableData(query) {
      ...
      const res = await api.stopTestApprovePageList(params)
