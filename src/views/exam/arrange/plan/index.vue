    ...
    <div>
      <el-form class="user-form" :inline="true">
        <el-form-item>
          ...
          <el-button class="info" plain @click="handlerPlanAdd">考试计划</el-button>
        </el-form-item>
        <el-form-item>
          <div class="organ-box">
            <el-select
...
export default {
    ...
    return {
      ...
      tableConfig: {
        ...
        columnConfig: [
          ...
          //   type: 'enums',
          //   enums: value => {
          //     const arr = vm.testTypeOptions.filter(
          //       item => item.value === value
          //     )
          //     return arr.length > 0 ? arr[0].label : '--'
          //   }
          ...
          //   type: 'enums',
          //   enums: value => {
          //     const arr = vm.examPaperOptions.filter(
          //       item => item.value === value
          //     )
          //     return arr.length > 0 ? arr[0].label : '--'
          //   }
  ...
  methods: {
    ...
    async getTableData(query) {
      ...
      const res = await api.getExamProfessionPageList(params)
    ...
    handleDelete({ row }) {
      this.$confirm('是否继续删除?', '提示', {
        ...
        api.deleteExamProfession({ id: row.id }).then((res) => {
          if (res.code === 200) {
            this.$message({
              type: 'success',
              message: '删除成功!',
