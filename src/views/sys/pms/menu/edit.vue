<template>
  <!--弹窗-->
  <el-dialog width="35%" :title="title" :visible.sync="visible" :before-close="handleClose">
    <el-form ref="formData" :model="formData" label-width="100px">
      ...
      <el-form-item label="图标：" v-if="formData.menuType === 1">
        <el-input type="text" placeholder="请输入内容" v-model="formData.menuIcon"></el-input>
      </el-form-item>
    </el-form>
