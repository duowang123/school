<template>
  <div class="student-plan-right pad20">
    ...
    <el-table-column label="退费分缴费方式统计（学费）">
      ...
      <el-table-column label="汇款">
        <el-table-column
          prop="transferPersonNumReturn"
          label="人数"
          width="80">
        </el-table-column>
        <el-table-column
          prop="transferAllReturn"
          label="总数"
          width="80">
        </el-table-column>
      </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getTableData() {
        api.payLogReport(this.form).then(res => {
