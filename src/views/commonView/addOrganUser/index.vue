      ...
      <el-form :model="user" :rules="rules" ref="ruleForm" label-width="0" class="ruleForm">
        <div class="basic">
          <div class="row">
            ...
            <div class="OEP-form-item margin_r_48">
              <div class="container">
                <p class="label">用户名<span class="required-icon">*</span></p>
            ...
            <div class="OEP-form-item margin_r_48">
              <div class="container">
                <p class="label">角色<span class="required-icon">*</span></p>
                <el-select
                    class="form-item-input"
                    v-model="user.roleId"
                    multiple
            ...
            <div class="OEP-form-item margin_r_48">
              <div class="container">
                <p class="label">联系电话(手机)<span class="required-icon">*</span></p>
            ...
            <div class="OEP-form-item margin_r_48">
              <div class="container">
                <p class="label">邮箱<span class="required-icon">*</span></p>
            ...
            <div class="OEP-form-item margin_r_48">
              <div class="container">
                <p class="label">联系电话(办公)<span class="required-icon">*</span></p>
  ...
  export default {
    ...
    computed: {
      unitCertUrl() {
        ...
        return pictureUrl ? `${BASE_API}/course${pictureUrl}?token=${getToken()}` : null
      },
      organId() {
    ...
    watch: {
      ...
      user: {
        handler(val) {
          if (val) {
            val.roleId = typeof val.roleId === 'string' ? val.roleId.split(',') : val.roleId
          }
        },
        immediate: true
      }
      ...
      return {
        ...
        rules: {
          ...
          'email': [
            ...
            { validator: testEmail, trigger: 'change' }
          ],
          'phone': [
            { required: true, message: '请输入联系电话', trigger: 'change' },
            { validator: testPhone, trigger: 'change' }
          ]
        }
      }
    },
