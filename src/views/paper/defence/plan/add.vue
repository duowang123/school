    ...
    <el-form :rules="rules" :model="ruleForm" ref="ruleForm" label-width="0">
      <div class="form-item">
        <div class="container">
          ...
          <el-form-item label="申请答辩起止时间" prop="start1">
            <datePicker :newVal="startend1" @returnBack="dateChange1" type="daterange"></datePicker>
          </el-form-item>
          <el-form-item label="正式答辩起止时间" prop="start2">
  ...
  export default {
    ...
    created() {
      if (!this.data.isAdd) {
        ...
        this.ruleForm.start1 = this.data.start1 || ''
        this.ruleForm.end1 = this.data.end1 || ''
        this.ruleForm.start2 = this.data.start2 || ''
        this.ruleForm.end2 = this.data.end2 || ''
        this.startend1 = [this.data.start1, this.data.end1]
        this.startend2 = [this.data.start2, this.data.end2]
      }
    },
    computed: {
