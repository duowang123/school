      ...
      tableConfig: {
        ...
        columnConfig: [
          ...
          },
          {
            ...
            type: 'enums',
            enums: (value) => {
              const arr = vm.statusOptions.filter(
                (item) => item.value === value
              )
              return arr.length > 0 ? arr[0].label : '--'
            },
          ...
          },
          {
            ...
            type: 'timeslot',
            value: (value) => {
              return (value.start3 || '--') + '-' + (value.end3 || '--')
            },
          },
          {
            label: '提交终稿起止时间',
            ...
            type: 'timeslot',
            value: (value) => {
              return (value.start4 || '--') + '-' + (value.end4 || '--')
            },
          },
          {
            label: '批改提纲起止时间',
            ...
            type: 'timeslot',
            value: (value) => {
              return (value.start5 || '--') + '-' + (value.end5 || '--')
            },
          },
          {
            label: '批改初稿起止时间',
            ...
            type: 'timeslot',
            value: (value) => {
              return (value.start6 || '--') + '-' + (value.end6 || '--')
            },
          },
          {
            label: '批改终稿起止时间',
            ...
            type: 'timeslot',
            value: (value) => {
              return (value.start7 || '--') + '-' + (value.end7 || '--')
            },
          },
          {
            label: '答辩终稿修改起止时间',
            ...
            type: 'timeslot',
            value: (value) => {
              return (value.start8 || '--') + '-' + (value.end8 || '--')
            },
          },
          {
            label: '论文重写申请起止时间',
            ...
            type: 'timeslot',
            value: (value) => {
              return (value.start9 || '--') + '-' + (value.end9 || '--')
            },
          },
          {
            label: '备注',
