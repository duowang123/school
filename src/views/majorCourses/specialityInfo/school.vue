  ...
  <div class="schoolStyle">
    ...
    <courses-table
      ...
      <template slot-scope="{ scope }">
        <el-button v-if="tableConfig.edit.includes(scope.$index)" type="text" @click="handleConfirm(scope)">确认</el-button>
...
<script>
    ...
    export default {
      ...
      methods: {
        ...
        getSchoolList() {
          api.schoolList(this.data.organId).then(res => {
